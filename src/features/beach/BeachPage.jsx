  ...
  return (
    <div className="beach-page" data-testid="page-beach">
      <section className="beach-hero" aria-label="Collection Plage">
        <img className="beach-hero__image" src="/Movera-host1/assets/plage-page-hero.jpeg?v=pure-white" alt="Collection Plage Movera" decoding="async" fetchPriority="high" />
