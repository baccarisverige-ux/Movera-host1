 ...
 * 1. Text finds candidate coordinates inside Tunisia only.
 * 2. A virtual fixed pin is moved to the best candidate.
 * 3. The same reverse-geocoding principle used by the host pin step scans
 *    exactly what is underneath that pin at zoom 18.
 * 4. The detected map object becomes the locked popup location.
 */
export async function scanTunisiaByVirtualPin(query, { signal, onCandidate } = {}) {
