 ...
 return <div className="search-v2" data-closing={closing?'true':'false'} role="dialog" aria-modal="true" aria-labelledby={titleId} aria-describedby={descriptionId}>
   ...
   <div className="search-v2__panel-shell">
    <MotionSurface ref={panelRef} className="search-v2__panel" variant="rise">
     <header className="search-v2__header"><button className="search-v2__close" onClick={()=>requestClose()} aria-label="Fermer la recherche"><span aria-hidden="true">×</span></button><div className="search-v2__heading"><span id={descriptionId}>Planifier votre séjour</span><strong id={titleId}>{STEPS[step]}</strong></div></header>
