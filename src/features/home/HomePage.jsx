...
import { homeCategories, homeCollections, homeDestinations, homeFeatured, homeServices } from './data/homeData.js'
...
import '../../styles/home-category-shape.css'
...
export function HomePage({onNavigate}){
 ...
 {homeCollections.map(collection=><Collection key={collection.id} title={collection.title} items={collection.items}/>)}
