...
const ProfilePage = lazyNamed(() => import('../../features/account/pages/ProfilePage.jsx'), 'ProfilePage')
const RegisterPage = lazyNamed(() => import('../../features/account/pages/RegisterPage.jsx'), 'RegisterPage')
const MessagesPage = lazyNamed(() => import('../../features/messages/MessagesPage.jsx'), 'MessagesPage')
const ThreadPage = lazyNamed(() => import('../../features/messages/ThreadPage.jsx'), 'ThreadPage')
const HostDashboardPage = lazyNamed(() => import('../../features/host/dashboard/HostDashboardPage.jsx'), 'HostDashboardPage')
const HostListingsPage = lazyNamed(() => import('../../features/host/listings/HostListingsPage.jsx'), 'HostListingsPage')
const HostListingCreatePage = lazyNamed(() => import('../../features/host/listings/HostListingCreatePage.jsx'), 'HostListingCreatePage')
const HostListingEditPage = lazyNamed(() => import('../../features/host/listings/HostListingEditPage.jsx'), 'HostListingEditPage')
const HostReservationsPage = lazyNamed(() => import('../../features/host/reservations/HostReservationsPage.jsx'), 'HostReservationsPage')
const HostCalendarPage = lazyNamed(() => import('../../features/host/calendar/HostCalendarPage.jsx'), 'HostCalendarPage')
const HostEarningsPage = lazyNamed(() => import('../../features/host/earnings/HostEarningsPage.jsx'), 'HostEarningsPage')
const HostSettingsPage = lazyNamed(() => import('../../features/host/settings/HostSettingsPage.jsx'), 'HostSettingsPage')
...
export const routeDefinitions = [
  { path: '/', area: 'guest', component: HomePage }, { path: '/plage', area: 'guest', component: BeachPage }, { path: '/maison-d-hote', area: 'guest', component: GuestHousePage }, { path: '/map', area: 'guest', component: MapPage }, { path: '/carousel-lab', area: 'guest', component: CarouselLab }, { path: '/gesture-lab', area: 'guest', component: GestureLab }, { path: '/resilience-lab', area: 'guest', component: ResilienceLab }, { path: '/listing/:id', area: 'guest', component: ListingDetailPage }, { path: '/booking/:id', area: 'guest', component: BookingPage }, { path: '/favorites', area: 'guest', component: FavoritesPage }, { path: '/messages', area: 'guest', component: MessagesPage, protected: true }, { path: '/messages/:id', area: 'guest', component: ThreadPage, protected: true }, { path: '/profile', area: 'guest', component: ProfilePage, protected: true }, { path: '/login', area: 'guest', component: LoginPage }, { path: '/register', area: 'guest', component: RegisterPage }, { path: '/forgot-password', area: 'guest', component: ForgotPasswordPage },
